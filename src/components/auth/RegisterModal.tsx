  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      try {
        ...
        if (!userSnap.exists()) {
          // New user — create user doc (no child info here)
        ...
        // Firestore unavailable — sign-in still succeeded
      }
      ...
      if (error.code !== 'auth/popup-closed-by-user') {
        ...
        setValidationError('Ocurrió un error al iniciar sesión. Intentá de nuevo.');
      }
    } finally {
      setIsLoading(false);
    }
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="bg-gradient-to-r from-indigo-500 to-purple-500 p-6 text-white text-center relative">
              ...
              <p className="text-indigo-100 font-medium text-sm">Iniciá sesión para guardar tu análisis</p>
            </div>

            {/* Body */}
            <div className="p-8 flex flex-col items-center gap-6">
              <p className="text-center text-slate-600 font-medium">
                Iniciá sesión con Google para guardar tu perfil y acceder a él en cualquier momento.
              </p>
